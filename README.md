...
see `cliroy/README.md`
or [docs](https://kilroybot.github.io/cliroy).
...
write the tests and put them in `cliroy/tests`.
...
Docs should be placed in `cliroy/docs/docs`. They
are pretty straightforward to write.

To build the docs,
`cd` into `cliroy/docs` and run:
